<?php
    ...
    /**
    * Objeto de valor que representa uma biblioteca.
    * Responsável por empréstimos de livros e operações com usuários com usuários.
    */ 
    class Biblioteca extends Banco
    {
        /**
